> For the complete documentation index, see [llms.txt](https://manual.specterapp.xyz/specter-unity-sdk/llms.txt). Markdown versions of documentation pages are available by appending `.md` to page URLs; this page is available as [Markdown](https://manual.specterapp.xyz/specter-unity-sdk/getting-started/configuration-and-initialization.md).
...
```
GET https://manual.specterapp.xyz/specter-unity-sdk/getting-started/configuration-and-initialization.md?ask=<question>
```
