# V2 API: `client/player/get-instant-battle-history`
...
|-------|------|----------|-------------|
| `userId` | `string` | **Yes** | The user ID to get instant battle history for |
...
### Example 1: Get Instant Battle History
**Request:**
```json
{
  "userId": "player-456",
...
### Example 2: Get History with Match Details
**Request:**
```json
{
  "userId": "player-456",
...
### Example 3: Filter by Competition IDs
**Request:**
```json
{
  "userId": "player-456",
  "competitionIds": ["quick-match", "daily-battle"],
  "scheduleStatuses": ["in progress", "completed"],
  "limit": 10
}
```
...
- Returns instant battle history for the specified user (competitionFormatTypeMasterId = 3)
...
- **DTO**: `src/competitions/dtos/get-other-instant-battle.dto.ts`
