# V2 API: `client/player/get-tournament-history`
...
|-------|------|----------|-------------|
| `userId` | `string` | **Yes** | The user ID to get tournament history for |
...
### Example 1: Get Tournament History
**Request:**
```json
{
  "userId": "player-456",
...
### Example 3: Filter by Competition IDs and Status
**Request:**
```json
{
  "userId": "player-456",
  "competitionIds": ["weekly-tournament", "daily-challenge"],
...
- Returns tournament history for the specified user (competitionFormatTypeMasterId = 2)
...
- **DTO**: `src/competitions/dtos/get-other-tournament.dto.ts`
