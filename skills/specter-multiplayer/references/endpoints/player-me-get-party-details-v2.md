# V2 API: `client/player/me/get-party-details`

**Endpoint:** `POST /v2/client/player/me/get-party-details`
...
```json
{
  "status": "success",
  "code": 200,
  "message": "My Party details fetched successfully",
  "data": {
    "party": {
...
### Example 1: Get My Party Details (Idle State)
**Request:**
```json
{}
```
...
### Example 3: Solo Party (Leader Only)
**Request:**
```json
{}
```
...
- Returns party details for the authenticated user's current party
...
| Error | Description |
|-------|-------------|
| Party not found | The user is not currently in any party (404) |
