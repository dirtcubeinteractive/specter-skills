# Admin API: `bundle/create`

**Endpoint:** `POST /v1/bundle/create`
...
## Request body — `CreateBundlesDto`

| Field | Type | Required | Allowed / Example | Description |
|---|---|---|---|---|
| `bundles` | CreateBundleDto[] | ✅ | see below | Array of bundles to create |


### Nested object: `CreateBundleDto`
