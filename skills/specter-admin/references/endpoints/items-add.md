...
## Request body — `CreateItemsDto`

| Field | Type | Required | Allowed / Example | Description |
|---|---|---|---|---|
| `items` | CreateItemDto[] | ✅ | see below | Array of items to create |


### Nested object: `CreateItemDto`

| Field | Type | Required | Allowed / Example | Description |
|---|---|---|---|---|
| `itemId` | string | — | e.g. `sword_001` | Unique identifier for the item |
...
| `itemPrices` | CreateItemPriceDto[] | — | see below | Prices for the item |
