# V2 API: `client/auth/login-email`

**Endpoint:** `POST /v2/client/auth/login-email`
...
- Triggers the `player_logged_in_with_email` event for task validation
...
- **DTO**: `src/users/dto/login-with-email.dto.ts`
