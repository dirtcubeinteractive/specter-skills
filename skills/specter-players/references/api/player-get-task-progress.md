# Client API (v2): `player/get-task-progress`
...
|---|---|---|---|---|
| `userId` | string | ✅ | e.g. `player-123` | User ID to get task progress for |
| `includeTaskGroupTasks` | boolean | — | e.g. `false` | Include tasks from task groups |
