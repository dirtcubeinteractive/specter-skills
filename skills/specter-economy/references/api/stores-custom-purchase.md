# Client API (v2): `stores/custom-purchase`

**Endpoint:** `POST /v2/client/stores/custom-purchase`

**Tag:** Stores

**Summary:** Custom purchase (V2)
...
## Request body — `CustomPurchaseV2Dto`

| Field | Type | Required | Allowed / Example | Description |
|---|---|---|---|---|
| `isItemOrBundlePresentInDefaultPurchase` | boolean | — | e.g. `true` | Whether item or bundle is present in purchase |
